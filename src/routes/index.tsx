  ...
  return (
    <>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-16 lg:py-20">
      ...
      <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl bg-card border border-border shadow-card">
          <div className="grid lg:grid-cols-[1fr_1.1fr]">
            <div className="p-10 lg:p-14">
              ...
              <Link to="/about" className="mt-7 inline-flex rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-transform hover:-translate-y-0.5">
                Explore Event
              </Link>
            </div>
            <div className="relative min-h-[260px]">
              <img src={ctaCampus} alt="Campus festival" className="absolute inset-0 h-full w-full object-cover" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl gradient-hero text-white shadow-elegant">
          <div className="grid lg:grid-cols-[1.1fr_1fr]">
            <div className="p-10 lg:p-16">
              ...
              <h3 className="mt-5 font-display text-4xl leading-tight text-balance sm:text-5xl">
            ...
            <div className="relative min-h-[260px]">
              <img src={ctaCampus} alt="" className="absolute inset-0 h-full w-full object-cover opacity-70" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
